...
$route['upload_delaytransaction'] = 'API/upload_delaytransaction';
$route['fetch_data'] = 'API/fetch_data';
$route['load_data'] = 'API/load_data';
$route['load_data_report'] = 'API/load_data_report';
$route['load_top_10'] = 'API/load_top_10';
...
$route['load_data_delaytransaction'] = 'API/load_data_delaytransaction';
